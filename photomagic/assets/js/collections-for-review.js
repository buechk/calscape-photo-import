...
export async function getCollectionsForReview() {
    await fetch('/photomagic/includes/php/collections_for_review.php')
...
function selectCollection(fileName) {
    ...
    const url = `/photomagic/includes/php/get_collection_contents.php?filename=${fileName}`;
...
function deleteCollections(fileNames) {
    ...
    const url = `/photomagic/includes/php/delete_collections.php?filenames=${encodeURIComponent(serializedFileNames)}`;
